...
export default function Home() {
  ...
  "logo": "https://www.lucknowlions.com/logo.png", 
  "description": "Lucknow Lions maximizes wealth for investors and traders by providing expert guidance and strategic investments in the stock market.",
  "founder": "Saurabh Srivastava",
  "foundingDate": "2015-09-15",
  "sameAs": [
    "https://www.facebook.com/LucknowLions2",
    "https://x.com/lucknowlions_",
    "https://www.linkedin.com/company/lucknowlions"
  ],
  "address": {
    "@type": "PostalAddress",
    "streetAddress": "8A Vrindavan Vihar, Gaushala Rd, Balaganj",
          ...
          <section className={`${styles.section} ${styles.features}`}>
            ...
            <div className={styles.featureslist}>
              ...
              <div className={`${styles.feature} ${styles.cardTn1}`}>
                ...
                <div>
                  <p>
                    <Link href="/fyers">Read More....</Link>
                  </p>
                  <a
