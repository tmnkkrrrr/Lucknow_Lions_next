      ...
      <section className="bg-gradient-to-b from-[#b2e0ff] via-[#f78a8a] to-[#f78a8a] w-full md:py-24 overflow-hidden">
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col md:flex-row items-center justify-between">
              ...
              <div className="w-full md:w-1/2">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-black leading-tight md:mb-4">
                  Buy Effortless &<br />Investing Sell
                </h1>
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-light italic text-white mb-4 md:mb-8">
                  Unique Trading
                </h2>

                <a className="bg-white text-[#f78a8a] font-semibold py-4 px-8 rounded-full text-lg mb-4 md:mb-10 hover:bg-opacity-90 transition-all shadow-md">
                  Open Demat Account
                </a>

                <p className="mt-8 text-white text-lg md:text-xl max-w-lg">
                ...
                {[
                  ...
                  <div key={feature.number} className="shadow-lg shadow-red-200 hover:shadow-2xl hover:shadow-red-200 p-6 rounded-lg transition-shadow duration-300">
                    <div className="flex items-center mb-3">
                      <div className="w-7 h-7 rounded-full bg-blue-500 text-white flex items-center justify-center text-sm font-medium mr-3">
                        {feature.number}
                      </div>
        ...
        <section className="py-12 px-4 bg-white">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className='mb-8 text-lg'>*Call and Trade Charges includes RMS Square off charges</div>
            ...
            <div className='mb-8 text-lg'>**CTT is applicable on Commodity Transactions only.</div>
        ...
        <section className='py-12 px-4'>
          ...
          <div className="max-w-7xl mx-auto overflow-hidden rounded-2xl shadow-lg">
            <div className="flex flex-col md:flex-row">
              <div className="w-full md:w-1/2 bg-green-500 p-6">
                <h2 className="text-white text-3xl font-bold underline text-center mb-8">Pros</h2>
                <div>
                  {[
              ...
              <div className="w-full md:w-1/2 bg-red-500 p-6">
                <h2 className="text-white text-3xl font-bold underline text-center mb-8">Cons</h2>
                <div>
                  {[
        ...
        <section className="bg-gradient-to-r from-red-400 to-red-600 py-16 md:py-24">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <h1 className="text-7xl md:text-6xl font-bold text-white mb-6 drop-shadow-md">
            ...
            <a
              href={link}
              className="inline-block bg-white text-red-600 text-xl font-bold py-3 px-10 rounded-md border-2 border-white hover:bg-transparent hover:text-white transition-colors duration-300 shadow-md"
            >
              Start Trading Now!
            </a>
          </div>
              ...
              {[
                {
                  ...
                  imageSrc: '/images/samco/img6.webp'
                },
                {
                  name: 'DhupeshDhameja',
                  title: 'Swing Trader Analytics',
                  imageSrc: '/images/samco/img7.webp'
                },
                {
                  name: 'Om Mehra',
                  title: 'Option Analytics',
                  imageSrc: '/images/samco/img8.webp'
                }
              ].map((analyst, index) => (
